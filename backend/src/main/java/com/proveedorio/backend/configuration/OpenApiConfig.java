package com.proveedorio.backend.configuration;
...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                // Metadatos de la API
                .info(new Info()
                        .title("API de Inventario Proveedorio")
                        .version("1.0")
                        .description("Documentación de la API para gestión de inventario y sincronización con proveedores.")
                        .contact(new Contact()
                                .name("Equipo de Desarrollo")
                                .email("dev@proveedorio.com")))

 ...
 * Usado por {@link com.laberit.backend.service.StockServiceImpl} para búsqueda, paginación y sincronización,
...
public interface MasterProductRepository extends JpaRepository<MasterProduct, Integer> {
     ...
     */
    @Query("SELECT new com.laberit.backend.dtos.dashboard.ChartDataDto(p.brand, COUNT(p)) " +

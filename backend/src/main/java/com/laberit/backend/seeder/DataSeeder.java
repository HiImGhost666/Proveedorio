...
import com.laberit.backend.entity.ProviderMapping;
...
import com.laberit.backend.repository.ProviderMappingRepository;
...
import com.laberit.backend.service.EncryptionService;
    ...
    private void seedAdminUser() {
        ...
        if (!userRepository.existsByUsername("admin")) {
            ...
            if (adminRoleOpt.isPresent()) {
                ...
                admin.setEmail("admin@laberit.com");
        ...
        if (!userRepository.existsByUsername("cliente")) {
            ...
            if (clienteRoleOpt.isPresent()) {
                ...
                cliente.setEmail("cliente@laberit.com");
